...
<div class="row">
  ...
  @if ($fecha > $viaje->fec_fin)
    ...
    <form action="{{ route('datoReporteViaje', $viaje->id) }}" method="POST" enctype="multipart/form-data">
    {!! csrf_field() !!}
    {!! method_field('PUT') !!}

    <div class="form-group">
      <label for="reporte">Reporte del viaje</label>
      <textarea name="reporte" id="reporte" cols="30" rows="3" class="form-control"></textarea>
    </div>
